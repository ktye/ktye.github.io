...
f_(_k,_K(z))
U_(w2,w_(2,s,n);0,in,ss)
g_(m_,r(M_(i?0:1l<<32,z,3,i?2:M,i,0),i?_d(i):0;$(z>>18,m9(r,z,14))))
U_(ms,Un=A(_n(s));Uz=m_(d_((U)s,0),n);r(a(n,z),_m(z,n)),_U a,ss)
U(b0,z&=0x8080808080808080;Ua=0;i(8,a|=(U)((__uint128_t)0x204081020408100*zi>>64)%256<<8*i)a,J z)
U(nc,nu(b(i)&b0((g)j==Gs)),ii,ij,ss)
is(ib,iu(~b0((g)i!=Gs)))
...
U(ni,*(U*)s=i?' fni':' nan';3,ss,ii)U($l,r(i,W(i--)(s[i]=48|n%10,n/=10)),ss,ii,in)U($i,n>>31?n<<1?(*s++=45,1+$i(s,-n)):ni(s,1):$l(s,l0(n),n),ss,in)
