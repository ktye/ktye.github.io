...
f4(q,q_)F4(z,z_)F4(PG,pg)xF(s8,padd,48)du(b,UX*b=&x;UX a=s8(s8(x8&b0,x8&b1),s8(x8&b2,x8&b3));a=s8(a,a);a0,Zx)zu(_b,1&0<(1<<nZ%8&z(x-Z3,nZ/8)))
#else
...
#if __AVX512F__
zz(q,zo(sqrtps)(x,4))zZ(z,zo(pshufb)(x,y))zZ(PG,bu(ia32_vfmaddsubps512_mask3)(z4(x,0xa0),y,z4(x,0xf5)*z4(y,0xb1),-1,9))du(b,zo(cvtb2mask)(x),Zx)zu(_b,zo(selectb_)(x,1+Z0,Z0))
#else
dY(q_,yo(sqrtps)(x),Yx)yY(z_,yo(pshufb)(x,y))yY(pg,yo(vfmaddsubps)(y4(x,0xa0),y,y4(x,0xf5)*y4(y,0xb1)))
f2(q,q_)F2(z,z_)F2(PG,pg)du(b,uu;i2*a=&u;Y*b=&x;a0=yo(pmovmskb)(b0);a1=yo(pmovmskb)(b1);u,Zx)zu(_b,1&0<(1<<nZ%8&z(x-Z3,nZ/8)))
#endif
#endif



Zi lt[]={3,0,0,2,2,3},g=95<<23;di(g_,~N&i?(N&i)/4|B(29)&m(g,i)-g:0,ii)di(_g,B(30)&i?g+((N/4&i)*4|B(29)&i):0,ii)iu(t,(u)i<<60|(5>i?x:g_(x)|(u)g_(x>>32)<<30))du(ie,*(i2*)&e,ee)zz(p,1/(EZ)x)
#define gx (_g(x)|(u)_g(x>>30)<<32)
#define tx (7&x>>60)
#define ox (B(25)&x>>32)
#define sx ((i0*)(W+32*ox))
Zi W[1<<28],H[25];f(Ww,i(25,Hi=(1<<i)-1)0)di(_o,W[32*j]=Hi;Hi=j,ii,ij)di(o_,r(Hi,Hi=W[32*r]),ii)di(o,Hi?o_(i):_o(i,o(i+1))+(1<<i),ii)di(bn,i+=67;128<i?l(i)-7:0,i)
...
f(r_,ax?x:(++xr,x))f(_r,ax?x:xr?(--xr,x):_t(x))du(ns,R(2,n,*(Z*)sr=*(Z*)s),in,ss)us(k,ns(i_(b(0==*(Z*)s)),s))nu(cv,*zx=*(Z*)(sx-1);sx[0]=n;x+1)iF(cV,sa[na]=i;_x(V(a+1,x)))
f(w,10>x?w(48+x):127>x?w_(1,(u)&x,1L):_(if(10!=sx[nx-1])(sx[nx]=10,++x);_x(w_(1,(u)sx,(u)nx))))du(err,w(cV(58,k(f),k(s)));Q,sf,ss)
