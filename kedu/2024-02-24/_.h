...
u(sl,ii=0;W(s[i])++i;i,ss)u(is,i(n,P(j==s[i],i))n,ij,in,ss)u(dn,i(n3(n),ru=xu)r,ur,in,ux)f(s_,r(0,N(r+=xc)))g(err,if(f)w(f);w(58);w(x);w(10);Q)
Zi i$(in,ss)__(r(0,i(n,r=10*r+s[i]%16)))Ze e$(in,ss)__(ii=is(46,n,s);n-=i;ij=n?i$(--n,s+i+1):0;(i$(i,s)*i9[n]+j)/(e)i9[n])
#include<complex.h>
#define ZE static E 
typedef complex float E;u(tE,ux=*(u*)&E;x>>32?x:1l<<63|x,E E)ZE E$(in,ss)__(ii=is(58,n,s);e$(i,s)+I*e$(n-i-1,s+i+1))
#if __arm64
