...
_V(g0,o(gathersiv16si)(z0,s,x,-1,1),ss,Vx)_V(g2,o(gathersiv16si)(z0,s,x,-1,4),ss,Vx)_V(g3,o(gathersiv8di)(z0,s,x,-1,8),ss,Yx)
Ef(ie,o(cvtps2dq512_mask)(x,z0,-1,4))Ef(_q,o(sqrtps512)(x,4))VF(p0,o(permvarqi512)(a,x))VF(p2,o(permvarsi512)(a,x))Vg(r0,p0(x,i?I0%4|15-I2<<2:63-I0))
_V(P2,o(vpermi2varps512)(a,b,x),Va,Vb,Vx)IF(_P,P2(a,2*I2,x))IF(P_,P2(a,1|2*I2,x))Vg(s0,4>i?o(vpermi2varqi512)(x,I0-(i0)i,z0):P2(x,I2-i/4,z0))
