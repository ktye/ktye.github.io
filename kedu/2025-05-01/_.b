...
U _k(U),m(U*,ss),_m(U,U),w(i2,ss);f(nu,o(popcountl)(x))f(iu,x?o(ctzl)(x):64)f(lu,--x?64-o(clzl)(x):0)Ui(n3,7+i>>3)Ui(n4,15+i>>4)Ui(n6,63+i>>6)
Ui(wc,w(1,&i);0)is(wl,w(i,s);wc(10))is(ic,sd=s;W(i!=*s)++s;s-d)Us(ws,wl(ic(0,s),s))
Ui(wi,r(i,Z0 b[12];in=i>>31;i=n?-i:i;ss=b+11;do*--s=48+i%10;W(i/=10);if(n)*--s='-';ws(s)))
#define h(b,z) {i2 $=b;i2 h=0;while(h<$){z;++h;}}
#define i(b,z) {i2 $=b;i2 i=0;while(i<$){z;++i;}}
#define j(b,z) {i2 $=b;i2 j=0;while(j<$){z;++j;}}
f(wu,cc[17];c[16]=10;i(16,in=15&x>>60-4*i;c[i]="0W"[9<n]+n)w(17,c);x)
...
#define m(a,b) _(typeof(b)$=b;(a)>$?(a):$) //#define MZ __attribute((minsize)) //noinline
...
#define i6(g,z,x...) D(i6,g,z,x)
#define e6(g,z,x...) D(e6,g,z,x)
#define g6(g,z,x...) D(g6,g,z,x)
#define j6(g,z,x...) D(j6,g,z,x)
