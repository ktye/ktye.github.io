...
V0(AO,1>m?Ag&Xg:Ag|Xg,im,EA,RX)V2(IV,$9(m,A6+Xi,A6-Xi,A6*Xi,G2(A,Xi),Ai+Xi,Ai-Xi,Ai*Xi,Ai/Xi,Ai*Xi/(1+E(-Xi))),im,EA,RX)
V0(b3,1&$3(m,c<Xg,c>Xg,c==Xg),im,cc,RX)V0(B3,1&GI($3(m-6,j<X8,j>X8,j==X8)),im,ij,RX)V2(iV,$4(m,j+X6,j-X6,j*X6,x((i1)j*X6>>16,j>>16?X6-(j>>16)*x:x)),im,ij,RX)
V2(ig,IG(X4),RX)V2(ei,EI(Xi),RX)V2(ie,IE(Xi),RX)V2(r2,R2(*--X),RX)V2(eV,$4(m,e+Xi,e-Xi,e*Xi,e/Xi),im,ee,RX)V2(eZ,E(Xi),RX)V2(qZ,Q(Xi),RX)
...
V(f2,n/=16;j(m/=16,i(n,Ez[16];h(16,zh=X[n*(16*j|h)|i])M2(1)M2(2)M2(4)M2(8)h(16,R[n*(16*i|h)|j]=zh))),im,RX)
