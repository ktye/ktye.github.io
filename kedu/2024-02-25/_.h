...
#define si s[i]
u(sl,ii=0;W(si)++i;i,ss)u(is,i(n,P(j==si,i))n,ij,in,ss)u(dn,i(n3(n),ru=xu)r,ur,in,ux)f(s_,r(0,N(r+=xc)))g(err,if(f)w(f);w(58);w(x);w(10);Q)
Zi i$(in,ss)__(r(0,i(n,r=10*r+si%16)))Ze e$(in,ss)__(ii=is(46,n,s);n-=i;ij=n?i$(--n,s+i+1):0;(i$(i,s)*i9[n]+j)/(e)i9[n])
f(r_,pax?x:(++xr,x))
#include<complex.h>
#define ZE static E 
