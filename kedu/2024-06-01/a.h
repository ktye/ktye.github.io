...
nS(i$,48>*s?-i$(n-1,s+1):r(0,i(n,r=si%16+10*r)))nS(e$,P(48>*s,N|e$(n-1,s+1))ii=ic(101,n,s);ue(n>i?i$(i,s)*E[s[i+1]%16]:n>(i=ic(46,n,s))?(n-=i+1,(i$(i,s)*E[n]+i$(n,s+i+1))/E[n]):i$(n,s)))
nS(f$,ii=ic(58,n,s);e$(i,s)|e$(n-i-1,s+i+1)<<32)nS(t3,qc(58,n,s)?2:qc(46,n,s)||qc(101,n,s))f(T$,cc=0;n(c=m(c,t3(nU,sU)))_R(3+c,nx,IF(2>c,n(ru=(c?e$:i$)(nU,sU)))n(rU=f$(nU,sU))))
