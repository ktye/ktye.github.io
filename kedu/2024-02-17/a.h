...
#include<complex.h>
typedef unsigned long(*_)(),u;typedef float e;typedef complex float E;E cexpf(E);Zi lt[]={3,0,0,2,2,3,3},O,W;Zu Q=128,U[26],ys();Ze pi=3.1415927;
...
#define wE(z) r((E)  (z),e*a=&r;b64 sprintf(b,"%g:%g\n",*a,a[1]);w((u)b))
