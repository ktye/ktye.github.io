...
#include"a.h"
#define AS(f,s,a...) ZU A(naked)f(a){asm(s"ret");}
#if linux
void _start(){asm("lea 8(%rsp),%rsi;call k9");o(ia32_ldmxcsr)(0xbfc0);}A(naked)V(P9,asm("mov $56,%rax;syscall;test%rax,%rax;jz L;ret;L:pop%rdi;jmp _p"),Uz,UZ)
#define O(f,i) AS(f,"mov %rcx,%r10;mov $"#i",%rax;syscall;",A(unused)Uz,...)
Zu M=0x4032;O(_K,60)O(_N,4)O(w_,1)O(_w,0)O(d_,2)O(_d,3)O(M_,9)O(_m,11)O(m9,28)O(_T,228)AS(T,"rdtsc;shl $32,%rdx;or %rdx,%rax;")U(_n,Ub[24];_N((U)s,b)>b[3]%2>>15?ws(s):b[6],ss)
#else //U(_n,ii=M>>14;Ub[24];_N((U)s,b)|!(1&b[i*3]>>(i?15:47))?ws(s):b[i?6:12])
#define O(f,i) AS(f,"mov x16,"#i"\nldr x1,[sp]\nldr x2,[sp,8]\nldr x3,[sp,16]\nldr x4,[sp,24]\nmov x5,0\nsvc 0\n",A(unused)Uz,...)
Zu M=0x1052;O(_K,1)O(_N,338)O(w_,4)O(_w,3)O(d_,5)O(_d,6)O(M_,197)O(_m,73)AS(T,"mrs x0,cntvct_el0\n")int main(int i,g**a){k9(a);}U(_n,Ub[24];_N((U)s,b)>b[0]%2>>47?ws(s):b[12],ss)
#endif
#define qd(x) (10u>x-48)
#define qn(x) (10u>x-48|27>x-96|34==x|41==x|93==x)//0a()[]-2
#define B(z) r(z,P(!r,0))
U k(ii,U,U),mo();U_(wr,w_(2,s,n);0,in,ss)g_(m_,r(M_(i?0:1l<<32,z,3,i?2:M,i,0),i?_d(i):0;$(z>>18,m9(r,z,14))))U_(ms,Un=B(_n(s));Uz=m_(d_((U)s,0),n);r(a(n,z),_m(z,n)),_ a,ss)
