...
_U(t_,o(ldmxcsr)(0xbfc0);ii=d_((U)"/sys/devices/system/cpu/cpu0/cpufreq/base_frequency",0);_w(i,d,2);_d(i);1e8*i$(2,d))AS(_t,"rdtsc;shl $32,%rdx;or %rdx,%rax;")
#else
...
U_(w_,W_(2,s,n),in,ss)Ui(wc,w_(1,&i);0)is(wl,w_(i,s);wc(10))is(ic,sd=s;W(i!=*s)++s;s-d)_U(ws,wl(ic(0,s),s),ss)
_U(_n,Ua[24];_N((U)s,a)|!(1&a[O?0:3]>>(O?47:15))?ws(s):a[O?12:6],ss)
U_(m_,Q(*a=_n(s));ii=d_((U)s,0);r(M_(0,*a,3,2,i,0),_d(i)),U*a,ss)
U_(_m,_M(a,x),Ua,Ux)
void k_(U);U ku(i2,U);void exit(ii){_k(i);}typedef long(*_)(U);e2 E9[]={1,10,1e2,1e3,1e4,1e5,1e6,1e7,1e8,1e9};
