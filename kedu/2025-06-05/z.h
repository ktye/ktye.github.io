...
U k(ii,U,U),_P();U_(_k,_P();_K(i),ii)
U_(wr,w_(2,s,n);0,in,ss)g_(m_,r(M_(i?0:1l<<32,z,3,i?2:M,i,0),i?_d(i):0;$(z>>18,m9(r,z,14))))U_(ms,Un=A(_n(s));Uz=m_(d_((U)s,0),n);r(a(n,z),_m(z,n)),_ a,ss)
