...
T(char,i0,V(g,4),V(g,5),V(g,6))T(unsigned short,i1)T(unsigned,i2,V(i,6),V(i,5),V(i,8))T(unsigned long,U,V(j,6))T(float,e2,V(e,6),V(e,5),V(e,7),V(e,8))T(int,V(s,6))
#undef T
#undef V
...
U w2(ii,ss),ws(ss),wi(ii);f(n4,15+x>>4)f(n6,63+x>>6)
f(nu,o(popcountl)(x))f(iu,x?o(ctzl)(x):64)f(lu,x?64-o(clzl)(x):0)Ui(wc,w2(1,&i);0)Ui(tb,t(1,i))Ui(ti,t(2,i))U(te,t(5,*(i2*)&e),ee)
