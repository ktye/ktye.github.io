#include"k.h"
e2 t;Z0 B=32,d[256];D(i2,i$,i&&48>*s?-i$(i-1,s+1):r(0,i(i,r=10*r+s[i]-48)),ii,ss)
#if linux//x86
...
U_(w_,W_(2,s,n),in,ss)U(_n,Ua[24];_N((U)s,a)|!(1&a[O?0:3]>>(O?47:15))?ws(s):a[O?12:6],ss)U_(_m,_M(a,x),Ua,Ux)
...
U(b0,z&=0x8080808080808080;Ux=0;i(8,x|=(U)((__uint128_t)0x204081020408100*z[i]>>64)%256<<8*i)x,Jz)ins(nc,nu(b(i)&b0((i0)n==Vs)))
#define sx ((i0*)ku(2,x))
#define ux ku(3,x)
#define H(g,z) U(g,z,Uf,Ua,Ux)
f(_r,ax?x:ku(0,x))f(r_,ax?x:ku(1,x))g(_i,k(12,x,ti(i)))H(k3,0)
