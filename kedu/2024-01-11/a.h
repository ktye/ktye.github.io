typedef unsigned char i0;typedef unsigned i2;typedef unsigned long(*_)(),u;typedef float e2;
#define m(x,y) _(typeof(y)y_=y;(x)>y_?(x):y_)
...
#define ux u x
#define uy u y
#define Qp(e) {uf=e;if(f)return prr(f,x);}
