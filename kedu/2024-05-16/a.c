...
g(a_,ii=f;t(Tx,$6(Tx,XU,1&xb>>i%32,xc,xu,xu,G_(xU))))U(f1,_K(nx,$(a_(i,x))),_ $,Ux)D(fr,_K(nx,$(a,a_(i,x))))G(e2,_K(nx,a2(f,ta?a:AU,tx?x:XU)))F(dx,if(!Tx)n(XU)dn(a,Nx,x))
f(v_,R(tx,1,*UR=5==tx?_G(x):x))f(_v,_(a_(0,x)))U(ln,R(Tx,n,dn(r,(U)n<<Lx,x+((int)i<<Lx))),ii,in,Ux)F(V_,__(R(Ta,na+nx,dx(dx(r,a),x))))F(_V,__(K(na,ln(au,au_-au,x))))g(vc,V_(x,v_(tc(f))))
...
f($t,x=$3(tx-3,$i(ux),$e(ex),x=_G(x);Ua=$e(ex);x>>=32;a|(14|$e(ex)<<4)<<4*z4(a));Vv=44+(15&a0(*(V*)&x,I0/2)>>I0%2*4);ns(z4(x),&v))
f($,tx?lx?$t(x):2>tx?v_(tc(48+ux)):$(v_(x)):$3(Tx-1,_T(2,48+_b(xu)),10!=x_&&qe(x)?_p(x):x,f1($,x)))
g(t_,x=f-1>Tx?t_(f-1,x):x;$4(f-2,_N(_b(xu)),x,_T(4,C(Ve,(Vi)Ix)),_T(5,Uu)))v1(_t,3>Tx?_N(O+(26>O-65&32)):_T(Tx-1,5>Tx?C(Vi,Ex):sq(_u*_u+u_*u_)))
g(T_,tx?t(f,$3(f-3,ux,ue((int)ux),G_(4>tx?T_(4,ux):ux))):t_(f,x))f(vk,Q(x)it=a(xx,ta);P(!t,x)n(Ua=xU;P(t!=ta,x))Qz(2!=L[t])_T(3,_u))
...
g(nz,Vv=Bx?ux?~u0:u0:3>tx?cx+(V){}:5>tx?u0+ux:U0+_G(x);L(tx,f,v))g(sS,in=f?nx:0;ij;n(Ua=xU;n+=j=na)_R(a(xx,Ta),n,Ua=r;n(a=dx(a,xU);if(f)*sa++=f)))f(r_,px||tx?x:M1&++rx?x:OO())
...
f(_r,P(px||tx,x)P(M1&rx,--rx;x)if(!Tx)n(_r(xU))_M(mx,x-n0);x)f(ra,QZ)
...
G(c3,$3(f,QZ,Qr(Tx)sS(a,x),Qr(!Tx)Ss(vc(a,x))))G(i3,Qz(f)P(2==Tx,x=vc(0,x);_((ua?_1:_0)(sx)))QZ)f(rr,Qz(2!=Tx)_R(2,nx,n(rc=sx[nx-1-i])))f(qr,Qr(1)0)f(ty,t(3,px?0:tx?:Tx))
Z_(h,ff,qr,qr,qr,qr,no,dt,gi,qr,ra,gE,_t,ge)Z_(H,ff,rr,_o,o_,og,no,dt,n_,_v,ou,_n,_t,or)g(LMS,QZ)
g(a1,P(17>f-1,Qr(px)$5(f-1,3==tx?++x:jJ(1,ti(1),x),3==tx?--x:jJ(1,ti(-1),x),jJ(3,r_(x),x),j4(-1,x),(tx?h:H)[f-5](x)))P(20>f,$3(f-18,v_(x),ty(x),x))LMS(f-20,x))Z_(G,No,Dt,N_,0,0,0,0,_C,C_,qr)
G(a2,P(19>f-1,P(pa||px,Qr(13!=f)a1(a,x))10>f?jJ(f,a,x):4>f-13?(15>f?AA:NN)(1&f-1,a,x):G[f-10](a,x))P(!f,Ll(a,x))Qz(29>f)f-=29;!f&&9>a-11?vk(f1(H[a-5],x)):$3(ta-2,c3,i3,p3)(f,a,x))
g(_$,_(t(3+f,$3(f,i$(nx,sx),e$(nx,sx),in=is(58,nx,sx);G_(e$(n,sx)|e$(nx-n-1,sx+n+1)<<32)))))f(t3,qg(58,x)?2:qg(46,x)||qg(101,x))
f(t$,P(qg(B,x),x=Ss(vc(B,x));it=0;n(t=m(t,t3(xU)))vk(fr(_$,t,x)))_$(t3(x),x))
U(v,_r(*_);*_=x,U*_,Ux)U(z_,Ua=x;x=xx;Ur;_W(ij=xc%32;Q(r=*c=$5(xc/32,--c;20>j?j:ti(j-20),j?a1(j,r):(--i,j=xc,r_(v(A(),r))),a2(j,r,*++c),--c;r_(*A()),--c;a_(j,a))))*c++,U*_,Ux)
Zc*P_=" L OSDE]  CARBK^@ GIHNM _ QP F J",*P9="3  5       01     2  4",*_P=":+-*%&|<>=~.!@?#_^,$LMSAVD...'/\\;()[]";f(_p,B3(90+(V){},10>O-20,O+28,96<O,O,a0(*(V*)_P,O%32)))g(_bp,_(bp(f,x)))
f(p_,B3(O,10>O-48,O-28,26>O-97,O,bl(26>O-65,a0(*(V*)P9,O-65)+4,a0(*(V*)P_,O-B-(57<O&10)-(90<O&26)-(122<O&27))-B)))f(Ba,0)f(a$,0)f(Bp,0)f(p$,0)f(Bd,0)f(d$,0)f(Bb,0)f(b$,0)
...
f(n$,V_(nz(n-1,tc(77)),x))f(r$,r(rr(x),*sr+=32))f(v$,B==sx[1]?x:r$(x))f(o$,*sx-=1==*sx/32?32:0;r$(x))
...
Us(zs,P(92==*s,ys(s+1))ii=is(s[1],2,": ");P(qa(*s)&&2>i,v(D+*s%32,(i?ps:zs)(s+2));0)Qx(ps)_(z_(0,x)))
Us(os,P(!*s||39==*s,0)Qx(zs)x?wx(x):0)Us(ls,Qx(_0)n(Ua=xU;Q(na?os(sa):_(96)))_(0))
...
f(_z,px?v_(tc(_P[x])):tx||!Lx?$(x):qf(x)?$(_v(x)):sS(B,f1(_z,x)))f(wx,x=sS(10,px||tx||Tx||qf(x)?v_(_z(x)):f1(_z,x));w_(2,x,nx);_(0))
