...
Z0*L=__DATE__"(c)arthur whitney (l)MIT",B=32,d[256];void*memset(void*d,int i,Un){VR=d;J(n,R_=(i0)i|z0)return d;}is(i$,48>*s?-i$(i-1,s+1):r(0,i(i,r=10*r+si-48)))
#if linux
...
Z2 E9[]={1,10,100,1e3,1e4,1e5,1e6,1e7,1e8,1e9};U_(w2,w_(2,(U)s,i);0,ii,ss)U_(QQ,ws(s);_k(1),ss)_u(wl,i-=d[i-1]==B;P(192>i,w0(i,d))d[189]=d[190]=46;w2(191,d))f(wb,i(64,d[i]=48|1&x>>i)w0(64,d);x)
...
#define sx ((i0*)k_(2,x))
extern U k_(i2,U),vak(U,U,U);f(_r,ax?x:k_(0,x))f(r_,ax?x:k_(1,x))g(_i,k(13,r_(x),ti(i)))Z0 F[27][64];ZU C[27][8],G[27],wx(U),ls(ss),qs(ii,ss),p(ii,ss),q(ii),e(i2,i0**),zs(ii,ss),ts(ii,ss);
