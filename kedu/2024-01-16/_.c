...
#if __AVX512F__
zz(q,zo(sqrtps)(x,4))zZ(z,zo(pshufb)(x,y))zZ(PG,wo(vfmaddsubps512_mask3)(z4(x,0xa0),y,z4(x,0xf5)*z4(y,0xb1),-1,9))du(b_,zo(cvtb2mask)(x),Zx)zu(_b,zo(selectb_)(x,1+Z0,Z0))
#else
...
#endif
#endif
Zi lt[]={3,0,0,2,2,3},g=95<<23;di(g_,~N&i?(N&i)/4|B(29)&m(g,i)-g:0,ii)di(_g,i=(N/4&i)*4|B(29)&i;~N&i?g+i:0,ii)iu(t,(u)i<<60|(5>i?x:g_(x)|(u)g_(x>>32)<<30))du(ie,*(i2*)&e,ee)zz(p,1/(EZ)x)
...
f(w,10>x?w(48+x):127>x?w_(1,(u)&x,1L):_(if(10!=sx[nx-1])(sx[nx]=10,++x);_x(w_(1,(u)sx,(u)nx))))du(err,w(cV(58,k(f),k(s)));Q,sf,ss)f(r_,ax?x:(++xr,x))f(_r,ax?x:xr?(--xr,x):_t(x))
