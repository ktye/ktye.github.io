...
#define SYS_MACINTOSH           32L             /* Think C                 */
#define SYS_MIPS                64L             /* GCC                     */
#define SYS_NEXT                128L            /* GCC                     */
#define SYS_PC                  256L            /* Turbo C                 */
#define SYS_PC386               512L            /* Watcom C 386            */
#define SYS_SGI                 1024L           /* GCC                     */
#define SYS_SUN3                2048L           /* GCC                     */
#define SYS_SUN386I             4096L           /* SunOS C                 */
#define SYS_SUN4                8192L           /* GCC                     */
#define SYS_VAX                 16384L
#define SYS_386IX               32768L          /* Interactive C           */
...
#define SYS_SESM                (SYS_ARCHIMEDES + SYS_PC + SYS_PC386 + \
                                 SYS_MACINTOSH)
#define SYS_UNIX                (SYS_ATT3B1 + SYS_IBMRS6000 + SYS_MIPS + \
                                 SYS_NEXT + SYS_SGI + SYS_SUN3 + SYS_SUN386I + \
...
#define ICMP(z,w,n)     memcmp((z),(w),(n)*sizeof(I))
#define ICPY(z,w,n)     memcpy((z),(w),(n)*sizeof(I))
