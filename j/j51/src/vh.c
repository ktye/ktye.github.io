...
static B fnea(u,v,k)A*u,*v;I k;{DO(k/4, if(one!=match(*u++,*v++))R 1;); R 0;}

static B fned(u,v,n)D*u,*v;I n;{DO(n, if(!teq(*u++,*v++))R 1;); R 0;}

static B fnej(u,v,n)Z*u,*v;I n;{DO(n, if(!zeq(*u++,*v++))R 1;); R 0;}

static B fne(fzz,t,u,v,n)B fzz;I t;C*u,*v;I n;{
 if(fzz)R t&FL  ? fned(u,v,n) : fnej(u,v,n);
 else   R t&BOX ? fnea(u,v,n) : memcmp(u,v,n);
}
