...
#define CCTRLD     '\004'       /*   4 004 04     ctrl d                   */
...
#define CLTCO      '\251'       /* 169 251 a9 [:                           */
#define CDEX       '\252'       /* 170 252 aa ].                           */
#define CRTCO      '\253'       /* 171 253 ab ]:                           */
...
#define CEPS       '\305'       /* 197 305 c5 e.                           */
#define CEBAR      '\306'       /* 198 306 c6 E.                           */
#define CFIX       '\307'       /* 199 307 c7 f.                           */
#define CIOTA      '\310'       /* 200 310 c8 i.                           */
#define CJDOT      '\311'       /* 201 311 c9 j.                           */
#define CCIRCLE    '\312'       /* 202 312 ca o.                           */
#define CPOLY      '\313'       /* 203 313 cb p.                           */
#define CRDOT      '\314'       /* 204 314 cc r.                           */
#define CALPHA     '\315'       /* 205 315 cd x.                           */
#define COMEGA     '\316'       /* 206 316 ce y.                           */
#define CZERO      '\340'       /* 224 340 e0 0:                           */
#define CONE       '\341'       /* 225 341 e1 1:                           */
#define CHOOK      '\342'       /* 226 342 e2                              */
#define CFORK      '\343'       /* 227 343 e3                              */
#define CADVF      '\344'       /* 228 344 e4     bonded conjunction       */
#define CHOOKO     '\345'       /* 229 345 e5                              */
#define CFORKO     '\346'       /* 230 346 e6                              */
#define CPDT       '\347'       /* 231 347 e7     plus dot times           */
